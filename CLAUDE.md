...
## 已知待办
1. ~~**照片历史查看器**~~ — 2026-06-13 已完成：聚合查询 12 表 + 年月筛选 + 网格展示 + 全屏查看
2. **安全员公告板** — 已完成（首页FAB悬浮按钮）
3. ~~`vehicle_admin_page.dart`~~ — 2026-06-13 已删除
4. 数据库车辆表为空，录车后才能用预算导入
5. ~~每日一测答题页~~ — 2026-06-11 已修复：5题逐题作答+回顾+排行榜+点赞
